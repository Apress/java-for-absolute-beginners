...
import com.apress.bgn.ch4.hierarchy.Artist;
import com.apress.bgn.ch4.hierarchy.Gender;
import com.apress.bgn.ch4.hierarchy.Human;
...
public class Graphician extends Human implements Artist {
    ...
    public Graphician(String name, int age, float height, Gender gender, String favoriteOs) {
